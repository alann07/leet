 ...
 *
 * A brilliant solution from forum.
 * https://leetcode.com/problems/maximum-sum-circular-subarray/solutions/178422/one-pass/?envType=study-plan-v2&envId=top-interview-150
 *
 * it turns the issue into total-minSum
 *
 * 6 ms Beats 73.19%, 48.62MB Beats 96.65%
 */
